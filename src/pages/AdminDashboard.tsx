...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-neo-lightgray flex">
      ...
      <button
        className="fixed top-4 left-4 p-2 bg-white border-2 border-black md:hidden"
      ...
      {/* Sidebar */}
      <div className={`fixed md:static inset-y-0 left-0 w-64 bg-white border-r-4 border-black flex flex-col transform transition-transform duration-300 ease-in-out z-10 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
